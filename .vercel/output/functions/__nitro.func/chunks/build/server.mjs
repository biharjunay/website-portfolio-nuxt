import { hasInjectionContext, inject, version, unref, computed, defineAsyncComponent, defineComponent, h, ref, provide, createElementBlock, shallowReactive, watch, Suspense, nextTick, Fragment, Transition, useSSRContext, getCurrentInstance, toRef, isRef, mergeProps, createApp, effectScope, reactive, getCurrentScope, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, shallowRef, isReadonly, toRaw, withCtx, isShallow, isReactive } from 'vue';
import { $ as $fetch, x as baseURL, y as hasProtocol, z as isScriptProtocol, A as joinURL, B as withQuery, c as createError$1, C as defu, D as sanitizeStatusCode, E as appendResponseHeader, F as getContext, G as createHooks, H as toRouteMatcher, I as createRouter$1 } from '../nitro/nitro.mjs';
import { defineStore, createPinia, setActivePinia, shouldHydrate } from 'pinia';
import { getActiveHead, CapoPlugin } from 'unhead';
import { defineHeadPlugin } from '@unhead/shared';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'vue-router';
import vSelect from 'vue-select';
import { ssrRenderAttrs, ssrRenderList, ssrRenderClass, ssrInterpolate, ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'vue/server-renderer';
import 'node:path';
import 'node:fs';
...
const _routes = [
  {
    name: "about",
    path: "/about",
    component: () => import('./about-DLiUk8Oi.mjs')
  },
  {
    name: "admin-about",
    path: "/admin/about",
    meta: __nuxt_page_meta$3,
    component: () => import('./about-CBkuZf6r.mjs')
  },
  {
    name: "admin",
    path: "/admin",
    meta: __nuxt_page_meta$2,
    component: () => import('./index-BZMnVkZt.mjs')
  },
  {
    name: "admin-user",
    path: "/admin/user",
    meta: __nuxt_page_meta$1,
    component: () => import('./user-BhfoFByN.mjs')
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import('./contact-Byyyi_ah.mjs')
  },
  {
    name: "home",
    path: "/home",
    component: () => import('./home-C-Pg7DMX.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-EZbIWTmv.mjs')
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta,
    component: () => import('./login-CFV6MxYj.mjs')
  },
  {
    name: "other",
    path: "/other",
    component: () => import('./other-Du-gQmaO.mjs')
  },
  {
    name: "portfolio",
    path: "/portfolio",
    component: () => import('./portfolio-suyZl41l.mjs')
  }
];
...
const namedMiddleware = {
  authenticated: () => import('./authenticated-C2yDuD2o.mjs')
};
...
const session_server_eidfPh9l5s = /* @__PURE__ */ defineNuxtPlugin({
  ...
  async setup(nuxtApp) {
    var _a;
    let __temp, __restore;
    nuxtApp.payload.isCached = Boolean((_a = useRequestEvent()) == null ? undefined : _a.context.cache);
...
const plugin_aqDqJyEoba = /* @__PURE__ */ defineNuxtPlugin((_nuxtApp) => {
});
const vue_select_8ji40gexSh = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
const layouts = {
  admin: defineAsyncComponent(() => import('./admin-C5toTIyL.mjs').then((m) => m.default || m)),
  default: defineAsyncComponent(() => import('./default-BdBGQahv.mjs').then((m) => m.default || m)),
  empty: defineAsyncComponent(() => import('./empty-CT1F38W1.mjs').then((m) => m.default || m))
};
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "alert-container" }, _attrs))} data-v-58b7e535><!--[-->`);
      ssrRenderList(unref(alertStore).alerts, (alert) => {
        _push(`<div class="${ssrRenderClass(`alert alert-${alert.type}`)}" data-v-58b7e535><span data-v-58b7e535>${ssrInterpolate(alert.message)}</span></div>`);
      });
      _push(`<!--]--></div>`);
    };
  }
...
_sfc_main$3.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/AlertComponent.vue");
  return _sfc_setup$3 ? _sfc_setup$3(props, ctx) : undefined;
};
const __nuxt_component_3 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-58b7e535"]]);
const _sfc_main$2 = {};
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  const _component_NuxtLayout = __nuxt_component_0;
  const _component_NuxtRouteAnnouncer = __nuxt_component_1;
  const _component_NuxtPage = __nuxt_component_2;
  const _component_AlertComponent = __nuxt_component_3;
  _push(ssrRenderComponent(_component_NuxtLayout, _attrs, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_NuxtRouteAnnouncer, null, null, _parent2, _scopeId));
        _push2(ssrRenderComponent(_component_NuxtPage, null, null, _parent2, _scopeId));
        _push2(ssrRenderComponent(_component_AlertComponent, null, null, _parent2, _scopeId));
      } else {
        return [
          createVNode(_component_NuxtRouteAnnouncer),
          createVNode(_component_NuxtPage),
          createVNode(_component_AlertComponent)
        ];
      }
    }),
    _: 1
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const _Error404 = defineAsyncComponent(() => import('./error-404-Bks8IUzO.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-Bwj9uway.mjs'));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import('./island-renderer-mH2x8ZXC.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export { _export_sfc as _, useAlertStore as a, useRoute as b, createError as c, defineNuxtRouteMiddleware as d, entry$1 as default, useRouter as e, nuxtLinkDefaults as f, resolveRouteObject as g, useNuxtApp as h, injectHead as i, useRuntimeConfig as j, navigateTo as n, resolveUnrefHeadInput as r, useUserSession as u };
