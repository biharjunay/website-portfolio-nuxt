...
import { SQLiteSession, SQLitePreparedQuery, SQLiteAsyncDialect, BaseSQLiteDatabase, sqliteTable, integer, text } from 'drizzle-orm/sqlite-core';
import { NoopLogger, entityKind } from 'drizzle-orm';
...
var generateKey = async (_crypto, password, options) => {
  var _a;
  if (!(password == null ? undefined : password.length))
...
const _xXDBMFUQc0 = defineNitroPlugin((nitroApp) => {
  nitroApp.hooks.hook("error", (error, context) => {
  });
});

const _s1G6DmpuoB = defineNitroPlugin((nitroApp) => {
...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "bd2c9f64-7923-45ac-b1e4-bfefd08ebcb5",
  ...
  "session": {
    "name": "nuxt-session",
    "password": "e05255c3432742cdb41cd23950ea8d29",
    "cookie": {
      "sameSite": "lax"
    }
  },
...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"/Users/mymac/Documents/belajar/website-portfolio-nuxt/.data/kv"}));
...
class DB0Session extends SQLiteSession {
...
class DB0PreparedQuery extends SQLitePreparedQuery {
...
const heroes = sqliteTable("heroes", {
...
const portfolios = sqliteTable("portfolio", {
  id: integer("id").primaryKey({ autoIncrement: true }),
...
const certifications = sqliteTable("certifications", {
  id: integer("id").primaryKey(),
  title: text("title").notNull(),
  yearStart: integer("year_start").notNull(),
  yearEnd: integer("year_end").notNull(),
...
const _4y87EP = eventHandler(async (event) => {
  await clearUserSession(event);
  return { loggedOut: true };
});

const _F2J3Nr = eventHandler(async (event) => {
...
const _lazy_VNP9YX = () => import('../routes/api/achievements/_id_.delete.mjs');
const _lazy_XKwyR6 = () => import('../routes/api/achievements/_id_.put.mjs');
const _lazy_x5u33N = () => import('../routes/api/index.get.mjs');
const _lazy_kgHXaG = () => import('../routes/api/index.post.mjs');
const _lazy_k6RENc = () => import('../routes/api/certifications/_id_.delete.mjs');
const _lazy_2pKgAM = () => import('../routes/api/certifications/_id_.put.mjs');
const _lazy_wjQ99C = () => import('../routes/api/index.get2.mjs');
const _lazy_vqzJBD = () => import('../routes/api/index.post2.mjs');
const _lazy_EjXrMe = () => import('../routes/api/educations/_id_.delete.mjs');
const _lazy_HgYb9N = () => import('../routes/api/educations/_id_.put.mjs');
const _lazy_iWs3lK = () => import('../routes/api/index.get3.mjs');
const _lazy_s0pKVT = () => import('../routes/api/index.post3.mjs');
const _lazy_d8illC = () => import('../routes/api/experiences/_id_.delete.mjs');
const _lazy_uXyGDy = () => import('../routes/api/experiences/_id_.put.mjs');
const _lazy_Y5qgrd = () => import('../routes/api/index.get4.mjs');
const _lazy_aOG9qr = () => import('../routes/api/index.post4.mjs');
const _lazy_VG96Jc = () => import('../routes/api/home.mjs');
const _lazy_AjrTNs = () => import('../routes/api/login.post.mjs');
const _lazy_Zp03J0 = () => import('../routes/api/portfolios/_id_.delete.mjs');
const _lazy_FtNZo9 = () => import('../routes/api/portfolios/_id_.put.mjs');
const _lazy_mTQRiq = () => import('../routes/api/index.get5.mjs');
const _lazy_exzbnH = () => import('../routes/api/index.post5.mjs');
const _lazy_ukER5M = () => import('../routes/api/register.post.mjs');
const _lazy_l8uCK0 = () => import('../routes/api/upload-image.post.mjs');
const _lazy_R7EH7u = () => import('../routes/renderer.mjs');

const handlers = [
  { route: '/api/achievements/:id', handler: _lazy_VNP9YX, lazy: true, middleware: false, method: "delete" },
  { route: '/api/achievements/:id', handler: _lazy_XKwyR6, lazy: true, middleware: false, method: "put" },
  { route: '/api/achievements', handler: _lazy_x5u33N, lazy: true, middleware: false, method: "get" },
  { route: '/api/achievements', handler: _lazy_kgHXaG, lazy: true, middleware: false, method: "post" },
  { route: '/api/certifications/:id', handler: _lazy_k6RENc, lazy: true, middleware: false, method: "delete" },
  { route: '/api/certifications/:id', handler: _lazy_2pKgAM, lazy: true, middleware: false, method: "put" },
  { route: '/api/certifications', handler: _lazy_wjQ99C, lazy: true, middleware: false, method: "get" },
  { route: '/api/certifications', handler: _lazy_vqzJBD, lazy: true, middleware: false, method: "post" },
  { route: '/api/educations/:id', handler: _lazy_EjXrMe, lazy: true, middleware: false, method: "delete" },
  { route: '/api/educations/:id', handler: _lazy_HgYb9N, lazy: true, middleware: false, method: "put" },
  { route: '/api/educations', handler: _lazy_iWs3lK, lazy: true, middleware: false, method: "get" },
  { route: '/api/educations', handler: _lazy_s0pKVT, lazy: true, middleware: false, method: "post" },
  { route: '/api/experiences/:id', handler: _lazy_d8illC, lazy: true, middleware: false, method: "delete" },
  { route: '/api/experiences/:id', handler: _lazy_uXyGDy, lazy: true, middleware: false, method: "put" },
  { route: '/api/experiences', handler: _lazy_Y5qgrd, lazy: true, middleware: false, method: "get" },
  { route: '/api/experiences', handler: _lazy_aOG9qr, lazy: true, middleware: false, method: "post" },
  { route: '/api/home', handler: _lazy_VG96Jc, lazy: true, middleware: false, method: undefined },
  { route: '/api/login', handler: _lazy_AjrTNs, lazy: true, middleware: false, method: "post" },
  { route: '/api/portfolios/:id', handler: _lazy_Zp03J0, lazy: true, middleware: false, method: "delete" },
  { route: '/api/portfolios/:id', handler: _lazy_FtNZo9, lazy: true, middleware: false, method: "put" },
  { route: '/api/portfolios', handler: _lazy_mTQRiq, lazy: true, middleware: false, method: "get" },
  { route: '/api/portfolios', handler: _lazy_exzbnH, lazy: true, middleware: false, method: "post" },
  { route: '/api/register', handler: _lazy_ukER5M, lazy: true, middleware: false, method: "post" },
  { route: '/api/upload-image', handler: _lazy_l8uCK0, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_R7EH7u, lazy: true, middleware: false, method: undefined },
  { route: '/api/_auth/session', handler: _4y87EP, lazy: false, middleware: false, method: "delete" },
  { route: '/api/_auth/session', handler: _F2J3Nr, lazy: false, middleware: false, method: "get" },
  { route: '/**', handler: _lazy_R7EH7u, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch$1 as $, joinURL as A, withQuery as B, defu as C, sanitizeStatusCode as D, appendResponseHeader as E, getContext as F, createHooks as G, toRouteMatcher as H, createRouter$1 as I, parseQuery as J, withTrailingSlash as K, withoutTrailingSlash as L, listener as M, drizzleDb as a, certifications as b, createError$1 as c, defineEventHandler as d, getQuery as e, educations as f, getRouterParam as g, experiences as h, readMultipartFormData as i, defineRenderHandler as j, buildAssetsURL as k, publicAssetsURL as l, getRouteRules as m, getResponseStatus as n, getResponseStatusText as o, portfolios as p, readBody as q, readValidatedBody as r, setUserSession as s, tables as t, useRuntimeConfig as u, destr as v, useNitroApp as w, baseURL as x, hasProtocol as y, isScriptProtocol as z };
